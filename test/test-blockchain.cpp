	...
	GIVEN( "a valid blockchain" ){
		...
		WHEN( "blockchain calculates publication trust on load" ){
			...
			THEN( "trust should match expected values" ){
                ...
                REQUIRE(blockchain.trust("A9A8D2EE0BD117F7048FC657234E0641CD78393347E7453936FD9FB84377A570") == 18.75);
                REQUIRE(blockchain.trust("C155EFCE2F1429CC37DA1BDE36EE478CA2EDE8DCDDC02D8C76AE2577A6B9A146") == 3.125);
                REQUIRE(blockchain.trust("ED6FBF3F6C3F94D0193341BABA2BE7AAF23E2A16FE78E9152BD77CD9C83B3664") == 11.71875);
			}
		}
	}
}
