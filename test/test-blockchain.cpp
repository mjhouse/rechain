	...
	GIVEN( "a valid blockchain" ){
		...
		WHEN( "blockchain calculates publication trust on load" ){
			...
			THEN( "trust should match expected values" ){
                REQUIRE(blockchain.trust("8CEB4B9EE5ADEDDE47B31E975C1D90C73AD27B6B165A1DCD80C7C545EB65B903") == 12.5);
                REQUIRE(blockchain.trust("A9A8D2EE0BD117F7048FC657234E0641CD78393347E7453936FD9FB84377A570") == 7.8125);
                REQUIRE(blockchain.trust("C155EFCE2F1429CC37DA1BDE36EE478CA2EDE8DCDDC02D8C76AE2577A6B9A146") == 2.734375);
                REQUIRE(blockchain.trust("ED6FBF3F6C3F94D0193341BABA2BE7AAF23E2A16FE78E9152BD77CD9C83B3664") == 7.71484375);
			}
		}
